...
import { useCourseDetailQuery } from '../api/useCourseDetailquery';
...
const CourseDetailPage = () => {
  ...
  const { data: courseDetail, isLoading, isError } = useCourseDetailQuery(id);
          ...
          <div className="lg:col-span-2">
            ...
            <section className="curriculum bg-zinc-50 dark:bg-zinc-800 p-6 shadow-lg rounded-xl mb-8">
              ...
              <ul className="space-y-6">
                {courseDetail.curriculum.map((item) => (
                  <li
                    key={item.id}
